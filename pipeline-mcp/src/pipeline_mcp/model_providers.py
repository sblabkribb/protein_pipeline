...
MODEL_SPECS: tuple[ModelSpec, ...] = (
    ...
    ModelSpec("colabfold", "ColabFold", ("COLABFOLD_ENDPOINT_ID", "COLABFOLD_RUNPOD_ENDPOINT_ID"), ("COLABFOLD_HTTP_URL", "COLABFOLD_GPU_URL"), ("COLABFOLD_HTTP_TOKEN",), ("COLABFOLD_HTTP_TIMEOUT_S",)),
